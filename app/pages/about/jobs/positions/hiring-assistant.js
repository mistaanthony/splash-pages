    ...
    return (
      <JobsPage>
        ...
        <p className='para'>
          ...
          working out of our amazing office in central London. We’ve grown
          from 30 people to 50 people since this time last year and we plan to
        ...
        <p className='para'>
          You’ll play a critical role in helping us to grow our incredibly
          talented team by ensuring our hiring pipeline runs smoothly and
          quickly. You’ll work closely with our hiring leads to ensure that
          our processes are working as they should be.
        </p>
        <p className='para'>
        ...
        <ul className='list'>
          <li>
            running the logistics for our recruitment efforts, from posting
            job ads to scheduling interviews and ensuring everyone involved
            knows what’s going on
          </li>
          <li>
            keeping meticulous oversight of our hiring and HR software so that
            every person is tracked from application to joining and beyond
          </li>
          <li>
            being the first point of contact for our candidates, answering
        ...
        <p className='para'>
          ...
          develop driven people that share our desire to do work we can be
          proud of. We value learning and feedback, and are devoted to
          encouraging and supporting each other’s continual professional growth.
          There will be scope for you to develop your role and take on more
          responsibility as our team continues to grow, and you’ll be able to
          get involved in developing and improving our hiring processes.
        </p>
        ...
        <a href='http://boards.greenhouse.io/gocardless/jobs/70631' className='btn u-margin-Vs'>
          Apply now
        </a>
      </JobsPage>
    );
